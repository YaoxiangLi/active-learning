...
```{r load packages}
# Only run this line for the first time installing packages
# install.packages(c("tidyverse","MASS","Hmisc"))
library(tidyverse)
library(MASS)
library(Hmisc)
```
...
data = readr::read_csv("https://raw.githubusercontent.com/lzyacht/active/master/data/Data_0109.csv")
